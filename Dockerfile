...
RUN addgroup -S pimatic \
    && adduser -G pimatic -S -D pimatic \
    && mkdir /home/pimatic/pimatic-app \
    && apk update \
    && apk add --no-cache python build-base tzdata curl git \
    && cd home/pimatic \
    ...
    && ln -s /mnt/pimatic-vol/config.json /home/pimatic/pimatic-app/config.json \
    && cd /home/pimatic/pimatic-app \
    && npm install sqlite3 \ 
    && cd /home/pimatic/pimatic-app/node_modules \
    && npm install pimatic-upnp-root \ 
                   pimatic-filter \
                   pimatic-openweather \
                   pimatic-cron \
